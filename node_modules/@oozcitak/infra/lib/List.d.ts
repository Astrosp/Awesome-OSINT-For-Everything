 ...
 * @param condition - an optional condition to match
 */
export declare function forEach<T>(list: Array<T>, condition?: ((item: T) => any)): Generator<T, void, unknown>;
/**
 ...
 */
export declare function sortInAscendingOrder<T>(list: Array<T>, lessThanAlgo: ((itemA: T, itemB: T) => boolean)): T[];
/**
 ...
 * is less than its second argument, and `false` otherwise.
 */
export declare function sortInDescendingOrder<T>(list: Array<T>, lessThanAlgo: ((itemA: T, itemB: T) => boolean)): T[];
